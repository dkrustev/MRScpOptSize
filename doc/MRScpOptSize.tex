...
\begin{itemize}
  ...
  \item ``exp growth'' (Fig. \ref{sfig:ExpGrowthPrg}-\subref{sfig:ExpGrowth}) is an example taken 
    from S{\o}rensen's thesis \cite[Example 11.4.1]{SorensenThesis}, who attributes it to Sestoft.
...
\end{lstlisting}
\caption{Selecting a Graph of Minimum/Maximum Size from a Graph Set}
\end{figure}
