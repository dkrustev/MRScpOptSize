...
Fig. \ref{sfig:ExpGrowthPrg}-\subref{sfig:ExpGrowth}, specialized to smaller input:
\verb|g(Cons(A, Nil), z)|.
A part of the resulting lazy graph (omitting sub-graphs for alternatives other than the first)
