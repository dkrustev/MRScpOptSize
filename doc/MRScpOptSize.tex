...
The configurations are typically organized in ``configuration trees/graphs'',
from which a new ``residual'' program can be generated as a final result.
...
Let us recall what driving looks like for this simple language, in the case of standard (positive) supercompilation.
