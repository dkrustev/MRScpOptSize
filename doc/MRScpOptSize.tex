...
\subsection{Multi-result Driving And Generalization}
...
Previous analyzes have shown that one of the main reasons for code size explosion in
...
These observations hint us to consider two guiding principles that should helps us attain our goal:
\begin{itemize}
...
\begin{itemize}
  ...
  \item The results of ``exp growth'' are especially interesting in view of our main goal.
    ...
    \verb|B(B(B(z, z), B(z, z)), B(B(z, z),| \verb|B(z, z)))| -- clearly suffering form code-size explosion.
